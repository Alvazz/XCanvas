...
public struct Arc {
    ...
    public static func vertex(_ vertex: CGPoint, _ pointA: CGPoint, _ pointB: CGPoint, radius: CGFloat) -> Arc {
        let line1 = Line(from: vertex, to: pointA)
        let line2 = Line(from: vertex, to: pointB)
